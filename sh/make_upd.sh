...
cat "phishingdomains.txt" "phishingdomains_newtoday.txt" "2021-07-18_nso.txt" >> "upd_nosort.txt"
...
rm "phishingdomains.txt" "phishingdomains_newtoday.txt" "2021-07-18_nso.txt" "upd_nosort.txt" "upd_sort.txt" "whitelist_sort.txt"
